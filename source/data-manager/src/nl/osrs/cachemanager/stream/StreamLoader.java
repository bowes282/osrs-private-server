...
public class StreamLoader {
	...
	public StreamLoader(byte abyte0[])
	{
		...
		dataLength = stream.readUnsignedWord();
		anIntArray728 = new int[dataLength];
		anIntArray729 = new int[dataLength];
		anIntArray730 = new int[dataLength];
		anIntArray731 = new int[dataLength];
		int k = stream.currentOffset + dataLength * 10;
