...
public abstract class Player {
	...
	public int bankItems[] = new int[Settings.BANK_SIZE];
	public int bankItemsN[] = new int[Settings.BANK_SIZE];
	...
	protected void appendPlayerAppearance(Stream str) {
		...
		if (!ItemWearing.isFullBody(playerEquipment[playerChest])) {
		...
		if (!ItemWearing.isFullHelm(playerEquipment[playerHat])
				&& !ItemWearing.isFullMask(playerEquipment[playerHat])) {
		...
		int mag = (int) ((PlayerAssistant.getLevelForXP(playerXP[6])) * 1.5);
		int ran = (int) ((PlayerAssistant.getLevelForXP(playerXP[4])) * 1.5);
		int attstr = (int) ((double) (PlayerAssistant.getLevelForXP(playerXP[0])) + (double) (PlayerAssistant.getLevelForXP(playerXP[2])));

		combatLevel = 0;
		if (ran > attstr) {
			combatLevel = (int) (((PlayerAssistant.getLevelForXP(playerXP[1])) * 0.25)
					+ ((PlayerAssistant.getLevelForXP(playerXP[3])) * 0.25)
					+ ((PlayerAssistant.getLevelForXP(playerXP[5])) * 0.125) + ((PlayerAssistant.getLevelForXP(playerXP[4])) * 0.4875));
		} else if (mag > attstr) {
			combatLevel = (int) (((PlayerAssistant.getLevelForXP(playerXP[1])) * 0.25)
					+ ((PlayerAssistant.getLevelForXP(playerXP[3])) * 0.25)
					+ ((PlayerAssistant.getLevelForXP(playerXP[5])) * 0.125) + ((PlayerAssistant.getLevelForXP(playerXP[6])) * 0.4875));
		} else {
			combatLevel = (int) (((PlayerAssistant.getLevelForXP(playerXP[1])) * 0.25)
					+ ((PlayerAssistant.getLevelForXP(playerXP[3])) * 0.25)
					+ ((PlayerAssistant.getLevelForXP(playerXP[5])) * 0.125)
					+ ((PlayerAssistant.getLevelForXP(playerXP[0])) * 0.325) + ((PlayerAssistant.getLevelForXP(playerXP[2])) * 0.325));
		}
	...
	public boolean wearing2h() {
		Client c = (Client) this;
		String s = ItemHandler.getItemName(c.playerEquipment[c.playerWeapon]);
		if (s.contains("2h"))
			return true;
	...
	public boolean isInRangeOfClickedObject() {
		return isInRangeOfClickedObject(1, 1);
	}
	
	public boolean isInRangeOfClickedObject(int xDiff, int yDiff) {
		return Math.abs(objectX - absX) <= xDiff && Math.abs(objectY - absY) <= yDiff;
	}
	...
	protected void appendHitUpdate(Stream str) {
		...
		str.writeByte(PlayerAssistant.getLevelForXP(playerXP[3])); // Their max hp, for HP bar
	...
	protected void appendHitUpdate2(Stream str) {
		...
		str.writeByteC(PlayerAssistant.getLevelForXP(playerXP[3])); // Their max hp, for HP bar
