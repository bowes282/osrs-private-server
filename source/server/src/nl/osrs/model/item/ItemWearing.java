 ...
 */
public class ItemWearing {

	/**
	 * Server cape IDs.
	 */
	public static int capes[] = { 9748, 9751, 9754, 9757, 9760, 9763, 9769, 9786, 2731, 2677, 2683, 2680, 2701, 2686, 2689,
	 ...
	 * Server boot IDs.
	 */
	public static int boots[] = { 11732, 7596, 8029, 6619, 8017, 7159, 7991, 6666,
	 ...
	 * Server shield IDs.
	 */
	public static int shields[] = { 8844, 8845, 8846, 8847, 8848, 8849, 8850, 11283, 7676, 7342, 7348, 7354, 7360, 7334, 7340,
	 ...
	 * Server hat IDs.
	 */
	public static int hats[] = { 11718, 9788, 10828, 2679, 2685, 2682, 2703, 2688, 2691, 2691,
	 ...
	 * Server body IDs.
	 */
	public static int body[] = { 11724, 11720, 7608, 2520, 430, 7362, 7364, 636, 638, 640,
	 ...
	 * Server leg IDs.
	 */
	public static int legs[] = { 11726, 11722, 7609, 2522, 7378, 7380, 7382, 7368, 7366,
	 ...
	 */
	public static int platebody[] = { 11724, 11720, 10338, 7608, 2520, 430, 636, 638, 640,
	 ...
	 */
	private static String[] fullhat = { "neitiznot", "med helm", "coif", "Dharok's helm",
	...
	public static boolean isFullBody(int itemId) {
		String weapon = ItemHandler.getItemName(itemId);
		if (weapon == null)
			return false;
	...
	static {
		...
		try {
			FileInputStream dataIn = new FileInputStream(new File(
					"../../data/server/data/stackable.dat"));
		...
		try {
			FileInputStream dataIn = new FileInputStream(new File(
					"../../data/server/data/equipment.dat"));
			while ((c = dataIn.read()) != -1) {
