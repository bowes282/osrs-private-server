...
public class Model extends Animable {
	...
	public static void addModel(byte abyte0[], int modelId) {
		try {
			if (abyte0 == null) {
				Class21 class21 = aClass21Array1661[modelId] = new Class21();
				class21.anInt369 = 0;
				class21.anInt370 = 0;
				class21.anInt371 = 0;
				return;
			...
			Class21 class21_1 = aClass21Array1661[modelId] = new Class21();
		...
		if (l1 >= 50) {
			...
			if (j2 >= 50) {
				...
				anIntArray1678[l] = j
						...
						/ 50;
				anIntArray1679[l] = k
						+ (k3 + ((anIntArray1669[k1] - k3) * k5 >> 16) << WorldController.viewDistance)
						/ 50;
				anIntArray1680[l++] = k4
			...
			if (i2 >= 50) {
				...
				anIntArray1678[l] = j
						...
						/ 50;
				anIntArray1679[l] = k
						+ (k3 + ((anIntArray1669[j1] - k3) * l5 >> 16) << WorldController.viewDistance)
						/ 50;
				anIntArray1680[l++] = k4
		...
		if (i2 >= 50) {
			...
			if (l1 >= 50) {
				...
				anIntArray1678[l] = j
						...
						/ 50;
				anIntArray1679[l] = k
						+ (l3 + ((anIntArray1669[i1] - l3) * i6 >> 16) << WorldController.viewDistance)
						/ 50;
				anIntArray1680[l++] = l4
			...
			if (j2 >= 50) {
				...
				anIntArray1678[l] = j
						...
						/ 50;
				anIntArray1679[l] = k
						+ (l3 + ((anIntArray1669[k1] - l3) * j6 >> 16) << WorldController.viewDistance)
						/ 50;
				anIntArray1680[l++] = l4
		...
		if (j2 >= 50) {
			...
			if (i2 >= 50) {
				...
				anIntArray1678[l] = j
						...
						/ 50;
				anIntArray1679[l] = k
						+ (i4 + ((anIntArray1669[j1] - i4) * k6 >> 16) << WorldController.viewDistance)
						/ 50;
				anIntArray1680[l++] = i5
			...
			if (l1 >= 50) {
				...
				anIntArray1678[l] = j
						...
						/ 50;
				anIntArray1679[l] = k
						+ (i4 + ((anIntArray1669[i1] - i4) * l6 >> 16) << WorldController.viewDistance)
						/ 50;
				anIntArray1680[l++] = i5
